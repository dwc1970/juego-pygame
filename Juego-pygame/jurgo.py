...
def show_go_screen():
	...
	draw_text(screen, "JUGAR", 65, WIDTH // 2, HEIGHT // 4)
	#draw_text(screen, "La nave se mueve con las flechas direccionales", 27, WIDTH // 2, HEIGHT // 2)
	#draw_text ( screen , "Dispara con la barra espaciadora" , 40 , WIDTH // 2 , HEIGHT // 2 )
